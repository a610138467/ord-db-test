...
fn main() -> Result<(), Error> {
    ...
    let db = Database::create("/Users/user/Downloads/index.redb")?;
    /*
    //导出当前所有的NFT信息
    ...
    //首先遍历得到所有的tokenId
    let mut nfts = tables::InscriptionNumberToInscriptionId::all(&db)?;
    ...
    */
    ...
    let mut block_number_to_hash = tables::HeightToBlockHash::all(&db)?;
